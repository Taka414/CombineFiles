...
namespace CombineFiles
{
    ...
    public class EncodeUtil
    {
        ...
        /// ファイルのエンコードを取得します。
        /// </summary>
        public static Encoding GetEncoding(string filePath) => GetEncoding(File.ReadAllBytes(filePath));
        ...
        {
            Encoding enc = DetectEncodingFromBOM(bytes);
            enc ??= GetCode(bytes);
            return enc;
        }

        // 参考:
        // https://www.eonet.ne.jp/~maeda/cs/check_code.htm
